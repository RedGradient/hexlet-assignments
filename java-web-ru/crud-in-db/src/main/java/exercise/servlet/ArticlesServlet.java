...
public class ArticlesServlet extends HttpServlet {
    ...
    private void createArticle(HttpServletRequest request,
        ...
        var sql = String.format("INSERT INTO articles (title, body) VALUES ('%s', '%s')", title, body);
    ...
    private void editArticle(HttpServletRequest request,
        ...
        // BEGIN
        var article = getArticleById(id, connection);
        // END
    ...
    private void updateArticle(HttpServletRequest request,
        ...
        // BEGIN
        var statement = connection.createStatement();
        var sql = String.format("UPDATE articles SET title='%s', body='%s' WHERE id=%s", title, body, id);
        statement.execute(sql);
        // END
    ...
    private void destroyArticle(HttpServletRequest request,
        ...
        // BEGIN
        var statement = connection.createStatement();
        var sql = String.format("DELETE FROM articles WHERE id=%s", id);
        statement.execute(sql);
        // END
