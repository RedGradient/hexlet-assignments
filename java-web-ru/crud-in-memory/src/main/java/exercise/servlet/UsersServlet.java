...
public class UsersServlet extends HttpServlet {
    ...
    private void newUser(HttpServletRequest request,
        ...
        // BEGIN
        var requestDispatcher = request.getRequestDispatcher("/new.jsp");
        requestDispatcher.forward(request, response);
        // END
    }
    ...
    private void editUser(HttpServletRequest request,
        ...
        // BEGIN
        request.setAttribute("user", user);
        var requestDispatcher = request.getRequestDispatcher("/edit.jsp");
        requestDispatcher.forward(request, response);
        // END
    }
    ...
    private void updateUser(HttpServletRequest request,
        ...
        if (firstName.isBlank() || lastName.isBlank()) {
            ...
            var message = "Ошибка в имени и/или фамилии";
