...
public class AppTest {
    ...
    void testUpdatePerson() throws Exception {
        ...
        assertThat(patchResponse.getStatus()).isEqualTo(HttpStatus.OK.value());

        var getResponse = mockMvc
                .perform(
                    get("/people/1")
                )
                .andReturn()
        ...
        var content = getResponse.getContentAsString();
        assertThat(content).contains("NewFirstName", "NewLastName");
        assertThat(content).doesNotContain("John", "Smith");
    }

    @Test
    void testDeletePerson() throws Exception {
        var delResponse = mockMvc
            .perform(delete("/people/1"))
            .andReturn()
            .getResponse();

        assertThat(delResponse.getStatus()).isEqualTo(HttpStatus.OK.value());
